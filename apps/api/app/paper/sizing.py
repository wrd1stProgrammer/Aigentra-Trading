...
SERVICE_MIN_MARGIN_DEPLOYMENT_PERCENT: Final = Decimal("12")
...
def minimum_margin_deployment_percent(settings: Any) -> Decimal:
    configured_minimum = _as_decimal(getattr(settings, "paper_min_margin_deployment_percent", 12), Decimal("12"))
    return max(
